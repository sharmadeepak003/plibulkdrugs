...
class ClaimSalesRequestEdit extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'ts_goods.*.relationship'=>'required|regex:/^[A-Za-z \t]*$/i',
            'ts_goods.*.ts_sales'=>'required_if:value[3],Y',
            'ts_goods.*.ep_sales'=>'required_if:value[3],Y',
            'baseline_tick'=>'required',
            'quantity_of_ep'=>'required_if:value[4],Y',
            'cost_production'=>'required_if:value[3],Y',
            ...
            'SalesConsumption.*.doc'=>'required_if:value[4],Y|mimes:pdf|max:20480',
    ...
    public function messages()
    {
        return[
            ...
            // 'SalesConsumption.*.upload.mimes'=>'File must be pdf.',
            ...
            // 'unsettled.*.upload.mimes'=>'File must be pdf.',
            // 'creditnotes.*.upload.mimes'=>'File must be pdf.',
            // 'salesconsideration.*.upload.mimes'=>'File must be pdf.',
            // 'contractagreement.*.doc_upload.mimes'=>'File must be pdf.',
