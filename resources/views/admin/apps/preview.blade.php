                                                ...
                                                <table class="table table-bordered table-hover table-sm">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                {{ number_format($value->networth,2) }}
                                                            </td>
                                                ...
                                                <table class="table table-bordered table-hover table-sm">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">{{ number_format($fin->phar_dom_17,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->phar_dom_18,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->phar_dom_19,2) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="text-center">Export</th>
                                                            <td class="text-center">{{ number_format($fin->phar_exp_17,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->phar_exp_18,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->phar_exp_19,2) }}</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <th class="text-center">Domestic</th>
                                                            <td class="text-center">{{ number_format($fin->oth_dom_17,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->oth_dom_18,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->oth_dom_19,2) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="text-center">Export</th>
                                                            <td class="text-center">{{ number_format($fin->oth_exp_17,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->oth_exp_18,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->oth_exp_19,2) }}</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">{{ number_format($fin->oth_inc_17,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->oth_inc_18,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->oth_inc_19,2) }}</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">{{ number_format($fin->tot_rev_17,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->tot_rev_18,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->tot_rev_19,2) }}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                                ...
                                                <table class="table table-bordered table-hover table-sm">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">{{ number_format($fin->pbt17,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->pbt18,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->pbt19,2) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="text-center">Profit After Tax</th>
                                                            <td class="text-center">{{ number_format($fin->pat17,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->pat18,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->pat19,2) }}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                                ...
                                                <table class="table table-bordered table-hover table-sm">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">{{ number_format($fin->cap_17,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->cap_18,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->cap_19,2) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="text-center">Share Capital Issued</th>
                                                            <td class="text-center">{{ number_format($fin->sh_cap_17,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->sh_cap_18,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->sh_cap_19,2) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="text-center">- Promoters</th>
                                                            <td class="text-center">{{ number_format($fin->eq_prom_17,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->eq_prom_18,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->eq_prom_19,2) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="text-center">- Indian Govt.</th>
                                                            <td class="text-center">{{ number_format($fin->eq_ind_17,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->eq_ind_18,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->eq_ind_19,2) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="text-center"> - Foreign Govt.</th>
                                                            <td class="text-center">{{ number_format($fin->eq_frn_17,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->eq_frn_18,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->eq_frn_19,2) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="text-center">- Multilateral Agencies</th>
                                                            <td class="text-center">{{ number_format($fin->eq_mult_17,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->eq_mult_18,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->eq_mult_19,2) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="text-center"> - Banks & Other institutions</th>
                                                            <td class="text-center">{{ number_format($fin->eq_bank_17,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->eq_bank_18,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->eq_bank_19,2) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="text-center">Internal Accruals</th>
                                                            <td class="text-center">{{ number_format($fin->int_acc_17,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->int_acc_18,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->int_acc_19,2) }}</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <th class="text-center"> Promoters</th>
                                                            <td class="text-center">{{ number_format($fin->ln_prom_17,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->ln_prom_18,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->ln_prom_19,2) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="text-center"> Indian Govt.</th>
                                                            <td class="text-center">{{ number_format($fin->ln_ind_17,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->ln_ind_18,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->ln_ind_19,2) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="text-center">  Foreign Govt.</th>
                                                            <td class="text-center">{{ number_format($fin->ln_frn_17,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->ln_frn_18,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->ln_frn_19,2) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="text-center"> Multilateral Agencies</th>
                                                            <td class="text-center">{{ number_format($fin->ln_mult_17,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->ln_mult_18,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->ln_mult_19,2) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="text-center"> Banks & Other institutions</th>
                                                            <td class="text-center">{{ number_format($fin->ln_bank_17,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->ln_bank_18,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->ln_bank_19,2) }}</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <th class="text-center"> Indian Govt.</th>
                                                            <td class="text-center">{{ number_format($fin->gr_ind_17,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->gr_ind_18,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->gr_ind_19,2) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="text-center"> Foreign Govt.</th>
                                                            <td class="text-center">{{ number_format($fin->gr_frn_17,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->gr_frn_18,2) }}</td>
                                                            <td class="text-center">{{ number_format($fin->gr_frn_19,2) }}</td>
                                                        </tr>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover table-sm">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="text-center">
                                                                {{ number_format($fin->rnd_inv_17,2) }}
                                                            </td>
                                                            <td class="text-center">
                                                                {{ number_format($fin->rnd_inv_18,2) }}
                                                            </td>
                                                            <td class="text-center">
                                                                {{ number_format($fin->rnd_inv_19,2) }}
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-bordered table-hover">
                                <tbody>
                                    <tr>
                                        <th><b>6.1</b></th>
                                        <th style="width: 8%" class="pl-1">Revenue (₹ in INR)</th>
                                        <td style="width: 92%" class="p-0">
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover table-sm">
                                                    <tbody>
                                                        <tr>
                                                        ...
                                                        <tr>
															...
															<td class="text-center">{{ number_format($rev->expfy20+$rev->expfy21+$rev->expfy22+$rev->expfy23+$rev->expfy24+$rev->expfy25+$rev->expfy26+$rev->expfy27+$rev->expfy28,2) }}</td>
                                                        </tr>
                                                        <tr>
															...
															<td class="text-center">{{ number_format($rev->domfy20+$rev->domfy21+$rev->domfy22+$rev->domfy23+$rev->domfy24+$rev->domfy25+$rev->domfy26+$rev->domfy27+$rev->domfy28,2) }}</td>
                                                        </tr>
														
														<tr>
                                                            <th>Total</th>
                                                            <td class="text-center">{{ number_format($rev->expfy20+$rev->domfy20,2) }}</td>
                                                            <td class="text-center">{{ number_format($rev->expfy21+$rev->domfy21,2) }}</td>
                                                            <td class="text-center">{{ number_format($rev->expfy22+$rev->domfy22,2) }}</td>
                                                            <td class="text-center">{{ number_format($rev->expfy23+$rev->domfy23,2) }}</td>
                                                            <td class="text-center">{{ number_format($rev->expfy24+$rev->domfy24,2) }}</td>
                                                            <td class="text-center">{{ number_format($rev->expfy25+$rev->domfy25,2) }}</td>
                                                            <td class="text-center">{{ number_format($rev->expfy26+$rev->domfy26,2) }}</td>
                                                            <td class="text-center">{{ number_format($rev->expfy27+$rev->domfy27,2) }}</td>
                                                            <td class="text-center">{{ number_format($rev->expfy28+$rev->domfy28,2) }}</td>
                                                        </tr>
                                        ...
                                        <td colspan="2" style="padding: 0;">
                                            <table style="margin: 0; width: 100%;">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="text-center">
                                                            {{ number_format($dvas->sal_exp,2) }}
                                                        </td>
                                                        <td class="text-center">
                                                            {{ number_format($dvas->oth_exp,2) }}
                                                        </td>
                                                        <td class="text-center">
                                                            {{ number_format($dvas->non_orig,2) }}
                                                        </td>
                                                        <td class="text-center">
                                                            {{ number_format($dvas->tot_cost,2) }}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <td colspan="2" style="padding: 0;">
                                            <table style="margin: 0; width: 100%;">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="text-center">{{ number_format($dvas->non_orig_raw,2) }}</td>
                                                        <td class="text-center">{{ number_format($dvas->non_orig_srv,2) }}</td>
                                                        <td class="text-center">{{ number_format($dvas->tot_a,2) }}</td>
                                                        <td class="text-center">{{ number_format($dvas->sales_rev,2) }}</td>
                                                        <td class="text-center">{{ number_format($dvas->dva,2) }}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </td>
        ...
        {{-- <div class="row pb-2">
            ...
            <div class="col-md-2 ">
                <div onclick="printPage();"
                    class="btn btn-warning btn-sm form-control form-control-sm">Print <i class="fas fa-print"></i> </div>
            </div>
        </div> --}}
    </div>
</div>
