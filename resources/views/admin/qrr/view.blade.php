...
@section('content')
    ...
    <div class="container ">
        @foreach ($appdata as $app)
            <div class="row">
                <div class="col-6 bg-mute text-center">
                    <span style="color:#DC3545;font-size:20px"> <b> Applicant's Name :</b></span><span
                        style="color:black;font-size:20px"> {{ $app->name }}</p></span>
                </div>
                <div class="col-6 bg-mute text-center">
                    <span style="color:#DC3545;font-size:20px"> <b> Quarter :</b></span><span
                        style="color:black;font-size:20px"> {{ $app->month }}-{{ $app->year }}</p></span>
                </div>
            </div>
            <div class="row">
                <div class="col-4 text-center">
                    <span style="color:#DC3545;font-size:16px"> <b> Application Number :</b></span><br><span
                        style="color:black;font-size:14px">{{ $app->app_no }}</span>
                </div>
                <div class="col-5 text-center">
                    <span style="color:#DC3545;font-size:16px"> <b> Target Segment :</b></span><br><span
                        style="color:black;font-size:14px">{{ $app->target_segment }}</span>
                </div>
                <div class="col-3 text-center">
                    <span style="color:#DC3545;font-size:16px"> <b> Product Name :</b></span><br><span
                        style="color:black;font-size:14px">{{ $app->product }}</span>
                </div>
            </div>
        @endforeach
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div style="float:right; padding:0;">
                    <a href="{{ route('admin.qrr.editmode', ['id' => $qrrData->id, 'qtr' => $qrrData->qtr_id]) }}"
                        class="btn btn-warning btn-sm btn-block " id="">Open QRR in Edit Mode</i></a>
                </div>
            </div>
        </div>
    @endif
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " id="appTab" data-toggle="pill" href="#approvalTab" role="tab"
                                aria-controls="appTabContent" aria-selected="false">Approvals Required</a>
                        </li>
                    </ul>
                </div>
                                                        ...
                                                        <table class="table table-sm table-bordered table-hover">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $companyDet->off_add }} ,
                                                                        {{ $companyDet->off_city }},
                                                                        {{ $companyDet->off_state }},
                                                                        {{ $companyDet->off_pin }}</td>
                                                                </tr>
                                                                <tr>
                                                        ...
                                                        <table class="table table-sm table-bordered table-hover">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>@if($pd){{ $pd->annual_capacity }}@else NA @endif</td>
                                                                </tr>
                                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <table class="table table-sm table-bordered table-hover">
                                                            <tbody>
                                                                <tr>
                                                                    <th style="width: 40%" class='pl-4'>Scheduled Commercial
                                                                        Date</th>
                                                                    <td style="width: 60%">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>@if($scod->commercial_op){{ $scod->commercial_op }}@else NA @endif</td>
                                                                    @else
                                                        ...
                                                        <table class="table table-sm table-bordered table-hover">
                                                            <tbody>
                                                                ...
                                                                @foreach ($green_mAddress as $item)
                                                                    <tr>
                                                                        <td>{{ $item->address }}</td>
                                                                        <td>@if($item->state){{$item->state }}@else NA @endif</td>
                                                                        <td>@if($item->city){{$item->city }}@else NA @endif</td>
                                                                        <td>@if($item->pincode){{$item->pincode }}@else NA @endif</td>
                                                                    </tr>
                                                                @endforeach
                                                            </tbody>
                                                        </table>
                                ...
                                <div class="card-body p-0">
                                    <div class="table-responsive">
                                        <table class="table table-sm table-bordered table-hover">
                                            <tbody>
                                                <tr>
                                                    <th style="width:15%" class='pl-4'>Project Details -Progress Report</th>
                                                    <td style="width:85%">
                                                        <table class="table table-sm table-bordered table-hover">
                                                            <tbody>
                                                                <tr>
                                                                    <th style="width:25%" class='pl-4'>Committed
                                                                        Investment<br>(₹ in Crore)</th>
                                                                    <td style="width:75%">
                                                                ...
                                                                @if ($qrrName == 202101)
                                                                    <tr>
                                                                        <th>Actual Investment upto March 2021<br>(₹ in
                                                                            Crore)</th>
                                                                        <td>{{ $finProg->totprevExpense }}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th style="width:25%" class='pl-4'>Actual
                                                                            Investment upto June 2021<br>(₹ in Crore)</th>
                                                                        <td style="width:75%">
                                                                ...
                                                                @else
                                                                    <tr>
                                                                        <th>Actual Investment upto
                                                                            {{ $oldcolumnName->month }}-{{ $oldcolumnName->yr_short }}<br>(₹
                                                                            in Crore)</th>
                                                                        <td>{{ $finProg->totprevExpense }}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th style="width:25%" class='pl-4'>Actual
                                                                            Investment upto
                                                                            {{ $currcolumnName->month }}-{{ $currcolumnName->yr_short }}<br>(₹
                                                                            in Crore)</th>
                                                                        <td style="width:75%">
                                                                            {{ $finProg->totcurrExpense }}</td>
                                                                    </tr>
                                                        ...
                                                        <table class="table table-sm  table-bordered table-hover">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    @if ($qrrName == 202101)
                                                                        <th class="text-center">Actual Investment
                                                                            upto March 2021 (₹ in crore)</th>
                                                                        <th class="text-center">Actual Investment
                                                                            upto June 2021(₹ in crore)</th>
                                                                    @else
                                                                        <th class="text-center">Actual Investment
                                                                            upto
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
                                                                        {{ $finProg->bprevExpense }}
                                                                    </td>
                                                                    <td class="text-center">
                                                                        {{ $finProg->bcurrExpense }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
                                                                        {{ $finProg->pprevExpense }}
                                                                    </td>
                                                                    <td class="text-center">
                                                                        {{ $finProg->pcurrExpense }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
                                                                        {{ $finProg->lprevExpense }}
                                                                    </td>
                                                                    <td class="text-center">
                                                                        {{ $finProg->lcurrExpense }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
                                                                        {{ $finProg->eprevExpense }}
                                                                    </td>
                                                                    <td class="text-center">
                                                                        {{ $finProg->ecurrExpense }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
                                                                        {{ $finProg->hprevExpense }}
                                                                    </td>
                                                                    <td class="text-center">
                                                                        {{ $finProg->hcurrExpense }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Water System</td>
                                                ...
                                                <tr>
                                                    <th style="width:15%" class='pl-4'>Status of Land for Greenfield Project
                                                    </th>
                                                    <td style="width:85%">
                                                        <table class="table table-sm  table-bordered table-hover">
                                                            <tbody>
                                ...
                                <div class="card-body p-0">
                                    <div class="table-responsive">
                                        <table class="table table-sm  table-bordered table-hover">
                                            <tbody>
                                                <tr>
                                                    <th style="width:15%">Revenue from Operations -[net of credit
                                                        notes,discounts and taxes applicable]</th>
                                                    <td style="width:85%">
                                                        <table class="table table-sm  table-bordered table-hover">
                                                            <tbody>
                                                                @if ($qrrName == 202101)
                                                                    <tr>
                                                                        ...
                                                                        <th class="text-center" colspan="2">FY2020-21
                                                                        </th>
                                                                        <th class="text-center" colspan="2">Quarter
                                                                            ended June-21</th>
                                                                    </tr>
                                                                    <tr>
                                                                        <th class="text-center"></th>
                                                                        <th class="text-center">Quantity<br>(Kg)</th>
                                                                        <th class="text-center">Sales for FY2020-21 <br>(₹)</th>
                                                                        <th class="text-center">Quantity<br>(Kg)</th>
                                                                        <th class="text-center">Sales for June-21 <br>(₹)</th>
                                                                    </tr>
                                                                @else
                                                                    <tr>
                                                                        <th class="text-center"></th>
                                                ...
                                                <table class="table table-sm  table-bordered table-hover">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">{{ $greenfield->empPrevNo }}
                                                            </td>
                                                            <td class="text-center">{{ $greenfield->empCurrNo }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th>Contractual</th>
                                                            <td class="text-center">{{ $greenfield->conPrevNo }}
                                                            </td>
                                                            <td class="text-center">{{ $greenfield->conCurrNo }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th>Apprentice</th>
                                                            <td class="text-center">{{ $greenfield->appPrevNo }}
                                                            </td>
                                                            <td class="text-center">{{ $greenfield->appCurrNo }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th>Total</th>
                                                            <td class="text-center">{{ $greenfield->totPrevNo }}
                                                            </td>
                                                            <td class="text-center">{{ $greenfield->totCurrNo }}
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                    ...
                                                    <tbody>
                                                        @if ($qrrName == 202101)
                                                            <tr>
                                                                ...
                                                                <th></th>
                                                                <th class="text-center" colspan="3">FY2020-21</th>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="text-center">Quantity<br>(Kg)</th>
                                                            <th class="text-center">Cost Price<br>(₹)</th>
                                                        ...
                                                        <tr>
                                                            <th>(B)- Consumption of Non-Originating Material & Services </th>
                                                            <td class="text-center">{{ $dva->totConprevquant }}</td>
                                                            <td></td>
                                                            <td class="text-center">{{ $dva->totConprevamount }}
                                                            </td>
                                                            <td class="text-center">{{ $dva->totConcurrquant }}</td>
                                                            <td></td>
                                                            <td class="text-center">{{ $dva->totConcurramount }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <td style="width:85%">
                                                <table class="table table-sm  table-hover">
                                                    <thead>
                                                        <tr>
                                                            @if ($qrrName == 202101)
                                                                <th class="text-center" colspan="4">For FY2020-21</th>
                                                                <th class="text-center" colspan="4">For June-21</th>
                                                            @else
                                                    ...
                                                    <tbody>
                                                        <td colspan="4">
                                                            <table class="table  table-sm">
                                                                <tbody>
                                                                    <tr>
                                                                        <th class="w-40">Breakup of
                                                                            Non-Originating Raw Material and Services</th>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    @if (count($serprev) > 0)
                                                                        @foreach ($serprev as $key => $item)
                                                                            <tr>
                                                                                <td class="text-center">
                                                                                    {{ $item->serrprevparticulars }}
                                                                                </td>
                                                                                <td class="text-center">
                                                                                    {{ $item->serrprevcountry }}</td>
                                                                                <td class="text-center">
                                                                                    {{ $item->serrprevquantity }}</td>
                                                                                <td class="text-center">
                                                                                    {{ $item->serrprevamount }}</td>
                                                                            </tr>
                                                                        @endforeach
                                                                        <tr>
                                                                            <th colspan="3">Total</th>
