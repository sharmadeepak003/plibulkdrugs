...
<div class="row">
    <div class="col-lg-12">
        <form action={{route('uploads.store')}} id="uploads-create" role="form" method="post"
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-bordered table-hover uploadTable">
                            ...
                            <tbody class="applicant-uploads">
                                <tr>
                                    <td><b>Photograph of the factory gate covering surroundings</b></td>
                                    <td>
                                ...
                                <tr>
                                    <td><b>Photograph of main Building Block for Plant and Machinery. In case Plant and Machinery is being installed in existing building, the photograph of site location</b></td>
                                     <td>
                                ...
                                <tr>
                                    <td> Photograph 1 of area where reactors and main production line is to be installed depciting installation work in progress
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td> Photograph 2 of area where reactors and main production line is to be installed depciting installation work in progress
                                    </td>
                                    <td>
            ...
            <div class="row pb-2">
                ...
                <div class="col-md-2 offset-md-3">
                    <a href="{{ route('qrradditionalinfo.edit',$qrr) }}" 
                    class="btn btn-warning btn-sm form-control form-control-sm">
...
{!! JsValidator::formRequest('App\Http\Requests\UploadsStore','#uploads-create') !!}
@endpush
