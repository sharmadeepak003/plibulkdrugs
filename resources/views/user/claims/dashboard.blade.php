        ...
        <div class="col-md-12">
            <div style="display: flex; margin:0.3rem; place-content:center;">
                ...
                {{-- <select name="1qrrvalue" id="1qrrvalue" onchange="dropdown1()" class="1qrrval"
                    ...
                    <option value="202101" @if ($qtr == 202101) selected @endif>FY 2020-21</option>
                    <option value="202101">July, 2021</option>
                    <option value="202102" @if ($qtr == 202102) selected @endif>Sept, 2021</option>
                    <option value="202103" @if ($qtr == 202103) selected @endif>Dec, 2021</option>
                    <option value="202104" @if ($qtr == 202104) selected @endif>Mar, 2022</option>
                    <option value="202201" @if ($qtr == 202201) selected @endif>June, 2022</option>
                </select> --}}
            ...
            <div class="col-md-2" style="float:right; padding:0;">
                <a href="{{ route('admin.qrr.exportall', ['qtr' => $qtr]) }}" class="btn btn-sm btn-warning"
                        ...
                        <div class="col-md-12">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <div class="col-md-auto " style="padding-top: 4px;padding-bottom:3px">
                                    ...
                                    class="btn btn-warning btn-sm form-control form-control-sm font-weight-bold" style="height: 45Px; width: 100px;">Send <i class="fa fa-envelope" aria-hidden="true" style="color:red"></i> Pending QRR</a>
                                </div>
                                <div class="col-md-auto " style="padding-top: 4px;padding-bottom:3px">
                                    @php
                                    use Carbon\Carbon;
