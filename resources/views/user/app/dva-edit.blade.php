...
<div class="row">
    <div class="col-lg-12">
        <form action={{ route('dva.update',$appMast->id) }} id="form-create" role="form" method="post"
                    ...
                    <div class="table-responsive rounded m-0 p-0">
                        <table class="table table-bordered table-hover table-sm" id="kraTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <input name="krm[{{ $key }}][id]" type="hidden" value="{{ $value->id }}">
                                    <td>
                                        <input type="text" name="krm[{{ $key }}][name]" placeholder="Key Raw Material"
                                            class="form-control form-control-sm" value="{{ $value->name }}">
                                    </td>
                                    <td>
                                        <select class="form-control form-control-sm" name="krm[{{ $key }}][coo]">
                                            <option value="" selected="selected">Please choose..</option>
                                            <option value="India" @if($value->coo == 'India') selected @endif>India
                                            </option>
                                            <option value="Outside India" @if($value->coo == 'Outside India') selected
                                                @endif>Outside India</option>
                                        </select>
                                    </td>
                                    <td>
                                        <input type="text" name="krm[{{ $key }}][man]" class="form-control form-control-sm"
                                            value="{{ $value->man }}">
                                    </td>
                                    <td>
                                        <input type="number" name="krm[{{ $key }}][amt]" class="form-control form-control-sm"
                                            value="{{ $value->amt }}">
                                    </td>
                                    <td class="pr-1">
                                    </td>
                        ...
                        <table class="table table-bordered table-hover table-sm" id="auditorTable">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="number" name="oth_exp" class="form-control form-control-sm"
                                            value="{{ $dvas->oth_exp }}"></td>
                                </tr>
                                <tr>
                                    <th class="p-1">Services non-originating in India</th>
                                    <td><input type="number" name="non_orig" class="form-control form-control-sm"
                                            value="{{ $dvas->non_orig }}"></td>
                                </tr>
                                <tr>
                                    <th class="p-1">Total Cost</th>
                                    <td><input type="number" name="tot_cost" class="form-control form-control-sm"
                                            value="{{ $dvas->tot_cost }}"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="number" name="non_orig_srv" class="form-control form-control-sm"
                                            value="{{ $dvas->non_orig_srv }}">
                                    </td>
                                </tr>
                                <tr>
                                    <th class="p-1">Total (A)</th>
                                    <td><input type="number" id="total_a" name="tot_a" class="form-control form-control-sm"
                                            value="{{ $dvas->tot_a }}"></td>
                                </tr>
                                <tr>
                                    <th colspan="5"></th>
                                ...
                                <tr>
                                    <th class="p-1">Estimated Sales Revenue (B) <br>
                                        <span class="help-text">Consider estimated sales value the product manufactured
                                            from total cost given above</span>
                                    </th>
                                    <td><input type="number" name="sales_rev" id="total_b" class="form-control form-control-sm"
                                            value="{{ $dvas->sales_rev }}"></td>
                                </tr>
                                <tr>
                                    <th colspan="5"></th>
                                </tr>
                                <tr>
                                    ...
                                    <td><input type="number" name="dva" id="dvatotal" readonly class="form-control form-control-sm"
                                            value="{{ $dvas->dva }}"></td>
                                </tr>
                            </tbody>
                        </table>
