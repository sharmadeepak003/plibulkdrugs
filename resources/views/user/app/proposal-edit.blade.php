...
<div class="row">
    <div class="col-lg-12">
        <form action={{ route('proposal.update',$appMast->id) }} id="form-create" role="form" method="post" class='form-horizontal'
                                        ...
                                        <tr>
                                            ...
                                            <td class="w-50">
                                                <textarea id="prop_man_add" name="prop_man_add"
                                                    class="form-control form-control-sm" rows="2">{{ $propDet->prop_man_add }}</textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="w-50 p-1">
                                            ...
                                            <td class="w-50">
                                                <textarea id="prop_man_det" name="prop_man_det"
                                                    class="form-control form-control-sm" rows="2">{{ $propDet->prop_man_det }}</textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="w-50">
                                                <textarea id="exst_man_add" name="exst_man_add"
                                                    class="form-control form-control-sm" rows="2">{{ $propDet->exst_man_add }}</textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="w-50">
                                                <input type="date" class="form-control form-control-sm" id="prod_date"
                                                    name="prod_date" value="{{ $propDet->prod_date }}">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="info_prov[{{ $val->id }}]"
                                                    ...
                                                    <option value="Y" @if($det->info_prov == 'Y')) selected @endif>Yes</option>
                                                    <option value="N" @if($det->info_prov == 'N')) selected @endif>No</option>
                                                </select>
                                            </td>
                                            <td>
                                                <input type="text" name="dpr_ref[{{ $val->id }}]"
                                                    class="form-control form-control-sm" value="{{ $det->dpr_ref }}">
                                            </td>
                                            <td>
                                                <input type="text" name="remarks[{{ $val->id }}]"
                                                    class="form-control form-control-sm" value="{{ $det->remarks }}">
                                            </td>
                                        </tr>
                                        @endif
                                        @endforeach
