...
<div class="row">
    <div class="col-lg-12">
        <form action={{ route('evaluations.store') }} id="form-create" role="form" method="post" class='form-horizontal'
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="amt[{{ $val->id }}]"
                                                    class="form-control form-control-sm @if($val->id!="17") majorheads @endif" @if($val->id=="17") readonly   id="totalmajorheads"   @endif>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
