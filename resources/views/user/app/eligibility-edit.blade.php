...
<div class="row">
    <div class="col-lg-12">
        <form action={{ route('eligibility.update',$appMast->id) }} id="form-create" role="form" method="post"
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <select class="form-control form-control-sm" id="greenfield" name="greenfield">
                                ...
                                <option value="Y" @if($elgb->greenfield == 'Y') selected @endif>Yes</option>
                                <option value="N" @if($elgb->greenfield == 'N') selected @endif>No</option>
                            </select>
                        </div>
                        <div class="col-md-6 form-group">
                            ...
                            <select class="form-control form-control-sm" id="bankrupt" name="bankrupt">
                                <option value="" selected="selected">Please choose..</option>
                                <option value="Y" @if($elgb->bankrupt == 'Y') selected @endif>Yes</option>
                                <option value="N" @if($elgb->bankrupt == 'N') selected @endif>No</option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="table-responsive rounded m-0 p-0">
                                <table class="table table-bordered table-hover table-sm" id="groupTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <input name="group[{{ $key }}][id]" type="hidden" value="{{ $value->id }}">
                                            <td>
                                                <input type="text" name="group[{{ $key }}][name]"
                                                    class="form-control form-control-sm" value="{{ $value->name }}">
                                            </td>
                                            <td>
                                                <input type="text" name="group[{{ $key }}][location]"
                                                    class="form-control form-control-sm" value="{{ $value->location }}">
                                            </td>
                                            <td>
                                                <input type="text" name="group[{{ $key }}][regno]"
                                                    class="form-control form-control-sm" value="{{ $value->regno }}">
                                            </td>
                                            <td>
                                                <input type="text" name="group[{{ $key }}][relation]"
                                                    class="form-control form-control-sm" value="{{ $value->relation }}">
                                            </td>
                                            <td>
                                                <input type="number" name="group[{{ $key }}][networth]"
                                                    class="form-control form-control-sm" value="{{ $value->networth }}">
                                            </td>
                                            <td class="pr-1">
                                                <a href="{{ route('group.delete',$value->id) }}"
                            ...
                            <div class="table-responsive rounded p-0 m-0">
                                <table class="table table-bordered table-hover table-sm">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="w-25">
                                                <select id="ut_audit" name="ut_audit"
                                                    ...
                                                    <option value="" selected="selected">Please choose..</option>
                                                    <option value="Y" @if($elgb->ut_audit == 'Y') selected @endif>Yes
                                                    </option>
                                                    <option value="N" @if($elgb->ut_audit == 'N') selected @endif>No
                                                    </option>
                                                </select>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select id="ut_sales" name="ut_sales"
                                                    class="form-control form-control-sm">
                                                    <option value="" selected="selected">Please choose..</option>
                                                    <option value="Y" @if($elgb->ut_sales == 'Y') selected @endif>Yes
                                                    </option>
                                                    <option value="N" @if($elgb->ut_sales == 'N') selected @endif>No
                                                    </option>
                                                </select>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <th class="p-1">
                                                Whether mandatory undertakings referred to in clause 17.6 of the scheme
                                                guidelines is being submitted. <br>
                                                (Integrity Pact)</th>
                                            <td>
                                                <select id="ut_integrity" name="ut_integrity"
                                                    class="form-control form-control-sm">
                                                    <option value="" selected="selected">Please choose..</option>
                                                    <option value="Y" @if($elgb->ut_integrity == 'Y') selected
                                                        @endif>Yes</option>
                                                    <option value="N" @if($elgb->ut_integrity == 'N') selected @endif>No
                                                    </option>
                                                </select>
                                            </td>
                                        </tr>
                    ...
                    <div class="row">
                        <div class="col-md-4 form-group">
                            ...
                            <select class="form-control form-control-sm" id="payment" name="payment">
                                <option value="" selected="selected">Please choose..</option>
                                <option value="Y" @if($fees->payment == 'Y') selected @endif>Yes</option>
                                <option value="N" @if($fees->payment == 'N') selected @endif>No</option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="date" class="col-form-label col-form-label-sm">Payment
                                    Date</label>
                                <input type="date" class="form-control form-control-sm" id="date" name="date" value="{{ $fees->date }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" id="urn" name="urn"
                                    placeholder="UR No" value="{{ $fees->urn }}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" id="bank_name" name="bank_name"
                                    placeholder="Name" value="{{ $fees->bank_name }}">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="amount" class="col-form-label col-form-label-sm">Amount</label>
                                <input type="number" class="form-control form-control-sm" id="amount" name="amount" value="{{ $fees->amount }}">
                            </div>
                        </div>
                    </div>
                </div>
