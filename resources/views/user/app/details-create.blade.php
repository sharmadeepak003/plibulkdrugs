...
<div class="row">
    <div class="col-lg-12">
        <form action={{ route('companydetails.store') }} id="comp-create" role="form" method="post"
                ...
                <div class="card-body p-1">
                    ...
                    <div class="card border-primary p-0 m-0">
                        ...
                        <div class="card-body">
                            ...
                            <span class="help-text">Provide 'Letter of Authorisation' as per format attached in the
                                section 'Undertakings & Certificates'.
                            </span>
                        </div>
                    </div>
                    <div class="card border-primary p-0 mt-1">
                        ...
                        <div class="card-body">
                            <span class="help-text">Refer Clause 7.3 of Scheme Guidelines, separate application along
                                with the application fee is required to be submitted for each eligible product.</span>
            ...
            <div class="card border-primary">
                ...
                <div class="card-body p-1">
                    <div class="row pb-2">
                        <div class="col-md-12">
                            <span class=" help-text">Provide copy of MOA and AOA in case of Company. LLPs may provide
                                copy of LLP Deed and MOA. In case of Partnership Firm, provide copy of partnership
                                agreement and registration deed if the Firm is registered.</span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="card border-primary p-0 mb-1">
                        ...
                        <div class="card-body p-0">
                            <span class="help-text">
                                <ol type="1">
                                    <li>Provide shareholding pattern of the Company with detail of shareholders having
                                        more than 1% shareholding giving clear break-up between shareholding of
                                        'Promoter & Promoter Group' and 'Others'. Companies listed in India may provide
                                        latest 'Shareholding Pattern' submitted to Stock Exchange, which should not be
                                        older than 3 months from the date of application.
                                        Applicant may also submit latest MGT 7 or MGT 9 filed with ROC.</li>
                                    <li>In case of Partnership Firm & Limited Liability Partnership provide detail for
                                        each partner, irrespective of their percentage of share.</li>
                                    <li>Proprietorship Firm shall give name of proprietor, capital with share mentioned
                                        as 100% under the head 'Promoter & Promoter Group'.</li>
                                </ol>
                            </span>
                            <div class="table-responsive rounded m-0 p-0">
                                <table class="table table-bordered table-hover table-sm" id="promTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="text" name="prom[0][name]"
                                                    class="form-control form-control-sm">
                                            </td>
                                            <td>
                                                <input type="text" name="prom[0][shares]"
                                                    class="form-control form-control-sm">
                                            </td>
                                            <td>
                                                <input type="text" name="prom[0][per]"
                                                    class="form-control form-control-sm totalshares">
                                            </td>
                                            <td>
                                                <input type="text" name="prom[0][capital]"
                                                    class="form-control form-control-sm">
                                            </td>
                                            <td class="pr-1">
                                            </td>
                                ...
                                <div class="table-responsive rounded m-0 p-0">
                                    <table class="table table-bordered table-hover table-sm p-0 m-0" id="otherTable">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="w-35">
                                                    <input type="text" name="other[0][name]"
                                                        class="form-control form-control-sm">
                                                </td>
                                                <td class="w-20">
                                                    <input type="text" name="other[0][shares]"
                                                        class="form-control form-control-sm">
                                                </td>
                                                <td class="w-20">
                                                    <input type="text" name="other[0][per]"
                                                        class="form-control form-control-sm othershareper">
                                                </td>
                                                <td class="w-20">
                                                    <input type="text" name="other[0][capital]"
                                                        class="form-control form-control-sm">
                                                </td>
                                                <td class="w-5 pr-1">
                                                </td>
            ...
            <div class="card border-primary">
                ...
                <div class="card-body p-0">
                    <span class="help-text">
                        Company/ LLP provide date as per ROC record. Partnership Firm may provide date of partnership
                        coming into existence. Proprietorship concern may give date of starting the business.
                    </span>
                    <div class="row p-1">
                        <div class="form-group col-md-7">
                            ...
                            <textarea id="bus_profile" name="bus_profile" class="form-control form-control-sm" rows="2"
                                placeholder="Brief Business Profile"></textarea>
                        </div>
                        <div class="form-group col-md-3">
                            <label class="col-form-label col-form-label-sm">Date of Incorporation </label><small
                                class="help-text">(Please attach copy)</small>
                            <input type="date" id="doi" name="doi" class="form-control form-control-sm">
                        </div>
                        <div class="form-group col-md-2">
                    ...
                    <div class="card border-primary p-0 mb-1">
                        ...
                        <div class="card-body p-0">
                            <span class="help-text">
                                Give details of all GST registrations and attach copy
                            </span>
                            <div class="table-responsive rounded m-0 p-0">
                                <table class="table table-bordered table-hover table-sm p-0 m-0" id="gstinTable">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="w-25">
                                                <input type="text" name="gstin[0][gstin]" placeholder="GSTIN"
                                                    class="form-control form-control-sm">
                                            </td>
                                            <td class="w-45">
                                                <input type="text" name="gstin[0][add]"
                                                    class="form-control form-control-sm">
                                            </td>
                                        </tr>
                                    </tbody>
                    ...
                    <div class="row border border-primary rounded m-0 mb-1">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="number" id="corp_pin" name="corp_pin" class="form-control form-control-sm">
                        </div>
                    </div>
                    {{-- Corporate Office --}}
                    <div class="row border rounded border-primary m-0 mb-1">
            ...
            <div class="card border-primary">
                ...
                <div class="card-body p-0">
                    <span class="help-text">
                        Company and LLPs may give detail of Auditors appointed under respective Act. Partnership Firm
                        and Proprietorship Firm may give detail of Independent Chartered Accountant appointed.
                    </span>
                    <div class="table-responsive rounded m-0 p-0">
                        <table class="table table-bordered table-hover table-sm" id="auditorTable">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <input type="text" name="aud[0][name]" placeholder="Name"
                                            class="form-control form-control-sm">
                                    </td>
                                    <td>
                                        <input type="text" name="aud[0][frn]" placeholder="FRN"
                                            class="form-control form-control-sm">
                                    </td>
                                    <td>
                                        <input type="text" name="aud[0][fy]" placeholder="2019-20"
                                            class="form-control form-control-sm">
                                    </td>
                                    <td class="pr-1">
                                    </td>
            ...
            <div class="card border-primary">
                ...
                <div class="card-body p-0">
                    <div class="row border rounded border-primary m-0 mb-1">
                        <span class="help-text">
                            <ol type="1">
                                <li>Provide 'Undertaking' as per format attached in the section 'Undertakings &
                                    Certificates'.
                                </li>
                                <li>Please mention CIBIL score and attach a copy of latest report downloaded from CIBIL.
                                    In case, the score is not available in CIBIL report, attach copy of report and
                                    mention as 'not available' in the box.
                                </li>
                            </ol>
                        </span>
                        <div class="form-group col-md-2">
                    ...
                    <div class="row border rounded border-primary m-0 mb-1 p-1">
                        ...
                        <div class="col-md-8">
                            <span class="help-text">
                                Please provide details of legal cases pending against the applicant/promoters as per
                                format provided under section Undertaking and Certificates.
                            </span>
                        </div>
                    </div>
                            ...
                            <div class="table-responsive rounded m-0 p-0">
                                <table class="table table-bordered table-hover table-sm" id="ratingTable">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <input type="text" name="rat[0][rating]"
                                                    class="form-control form-control-sm rating">
                                            </td>
                                            <td>
                                                <input type="email" name="rat[0][name]"
                                                    class="form-control form-control-sm ratingname">
                                            </td>
                                            <td>
                                                <input type="date" name="rat[0][date]"
                                                    class="form-control form-control-sm ratingdate">
                                            </td>
                                            <td>
                                                <input type="date" name="rat[0][validity]"
                                                    class="form-control form-control-sm ratingvalidity">
                                            </td>
                                            <td class="pr-1">
                                            </td>
                                        </tr>
                            ...
                            <div class="table-responsive rounded m-0 p-0">
                                <table class="table table-bordered table-hover table-sm" id="topManTable">
                                    <thead>
                                        <tr>
                                            <td colspan="6">
                                                <span class="help-text">
                                                    <ol type="1">
                                                        <li>Provide detail of Directors having executive positions. LLPs
                                                            to provide detail of 'Designated Partner'. Partnership Firm
                                                            to provide detail of Managing Partner and other active
                                                            partners. Proprietor firm may provide detail of proprietor
                                                        </li>
                                                        <li>Attach a brief profile of the Chairman/ CEO/ Promoter/
                                                            Partner/ Proprietor
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <input type="text" name="topMan[0][name]" placeholder="Name"
                                                    class="form-control form-control-sm">
                                            </td>
                                            <td>
                                                <input type="email" name="topMan[0][email]" placeholder="E-Mail"
                                                    class="form-control form-control-sm">
                                            </td>
                                            <td>
                                                <input type="number" name="topMan[0][phone]" placeholder="Phone"
                                                    class="form-control form-control-sm">
                                            </td>
                                            <td>
                                                <input type="number" name="topMan[0][din]" placeholder="DIN"
                                                    class="form-control form-control-sm">
                                            </td>
                                            <td>
                                                <input type="text" name="topMan[0][add]" placeholder="Name"
                                                    class="form-control form-control-sm">
                                            </td>
                                            <td class="pr-1">
                                            </td>
            ...
            <div class="card border-primary">
                ...
                <div class="card-body p-0">
                    <span class="help-text">
                        Provide detail of 'Key Managerial Personnel' like CEO, CFO, Company Secretary, Plant Head not
                        covered above
                    </span>
                    <div class="table-responsive rounded m-0 p-0">
                        <table class="table table-bordered table-hover table-sm" id="kmpTable">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <input type="text" name="kmp[0][name]" placeholder="Name"
                                            class="form-control form-control-sm">
                                    </td>
                                    <td>
                                        <input type="email" name="kmp[0][email]" placeholder="E-Mail"
                                            class="form-control form-control-sm">
                                    </td>
                                    <td>
                                        <input type="number" name="kmp[0][phone]" placeholder="Phone"
                                            class="form-control form-control-sm">
                                    </td>
                                    <td>
                                        <input type="text" name="kmp[0][pan_din]" placeholder="Designation"
                                            class="form-control form-control-sm">
                                    </td>
                                    <td class="pr-1">
                                    </td>
            ...
            <div class="row pb-2">
                ...
                <div class="col-md-2 offset-md-3">
                    <a href="#" class="btn btn-warning btn-sm form-control form-control-sm disabled"><i
