...
<div class="row">
    <div class="col-lg-12">
        <form action={{ route('financials.update',$appMast->id) }} id="form-create" role="form" method="post" class='form-horizontal'
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="phar_dom_17" id="phar_dom_17"
                                                    class="form-control form-control-sm" value="{{ $fin->phar_dom_17 }}"></td>
                                            <td><input type="number" name="phar_dom_18" id="phar_dom_18"
                                                    class="form-control form-control-sm" value="{{ $fin->phar_dom_18 }}"></td>
                                            <td><input type="number" name="phar_dom_19" id="phar_dom_19"
                                                    class="form-control form-control-sm" value="{{ $fin->phar_dom_19 }}"></td>
                                        </tr>
                                        <tr>
                                            <td>Export</td>
                                            <td><input type="number" name="phar_exp_17" id="phar_exp_17"
                                                    class="form-control form-control-sm" value="{{ $fin->phar_exp_17 }}"></td>
                                            <td><input type="number" name="phar_exp_18" id="phar_exp_18"
                                                    class="form-control form-control-sm" value="{{ $fin->phar_exp_18 }}"></td>
                                            <td><input type="number" name="phar_exp_19" id="phar_exp_19"
                                                    class="form-control form-control-sm" value="{{ $fin->phar_exp_19 }}"></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="oth_dom_17" id="oth_dom_17"
                                                    class="form-control form-control-sm" value="{{ $fin->oth_dom_17 }}"></td>
                                            <td><input type="number" name="oth_dom_18" id="oth_dom_18"
                                                    class="form-control form-control-sm" value="{{ $fin->oth_dom_18 }}"></td>
                                            <td><input type="number" name="oth_dom_19" id="oth_dom_19"
                                                    class="form-control form-control-sm" value="{{ $fin->oth_dom_19 }}"></td>
                                        </tr>
                                        <tr>
                                            <td>Domestic</td>
                                            <td><input type="number" name="oth_exp_17" id="oth_exp_17"
                                                    class="form-control form-control-sm" value="{{ $fin->oth_exp_17 }}"></td>
                                            <td><input type="number" name="oth_exp_18" id="oth_exp_18"
                                                    class="form-control form-control-sm" value="{{ $fin->oth_exp_18 }}"></td>
                                            <td><input type="number" name="oth_exp_19" id="oth_exp_19"
                                                    class="form-control form-control-sm" value="{{ $fin->oth_exp_19 }}"></td>
                                        </tr>
                                        <tr>
                                            <th class="p-0 m-0">Other Income</th>
                                            <td><input type="number" name="oth_inc_17" id="oth_inc_17"
                                                    class="form-control form-control-sm" value="{{ $fin->oth_inc_17 }}"></td>
                                            <td><input type="number" name="oth_inc_18" id="oth_inc_18"
                                                    class="form-control form-control-sm" value="{{ $fin->oth_inc_18 }}"></td>
                                            <td><input type="number" name="oth_inc_19" id="oth_inc_19"
                                                    class="form-control form-control-sm" value="{{ $fin->oth_inc_19 }}"></td>
                                        </tr>
                                        <tr>
                                            <th class="p-0 m-0"> Total Revenue</th>
                                            <td><input type="number" name="tot_rev_17" id="tot_rev_17"
                                                    class="form-control form-control-sm" value="{{ $fin->tot_rev_17 }}"></td>
                                            <td><input type="number" name="tot_rev_18" id="tot_rev_18"
                                                    class="form-control form-control-sm" value="{{ $fin->tot_rev_18 }}"></td>
                                            <td><input type="number" name="tot_rev_19" id="tot_rev_19"
                                                    class="form-control form-control-sm" value="{{ $fin->tot_rev_19 }}"></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <span class="help-text">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="number" name="pbt17" id="pbt17"
                                                    class="form-control form-control-sm" value="{{ $fin->pbt17 }}"></td>
                                            <td><input type="number" name="pbt18" id="pbt18"
                                                    class="form-control form-control-sm" value="{{ $fin->pbt18 }}"></td>
                                            <td><input type="number" name="pbt19" id="pbt19"
                                                    class="form-control form-control-sm" value="{{ $fin->pbt19 }}"></td>
                                        </tr>
                                        <tr>
                                            <th>Profit After Tax</th>
                                            <td><input type="number" name="pat17" id="pat17"
                                                    class="form-control form-control-sm" value="{{ $fin->pat17 }}"></td>
                                            <td><input type="number" name="pat18" id="pat18"
                                                    class="form-control form-control-sm" value="{{ $fin->pat18 }}"></td>
                                            <td><input type="number" name="pat19" id="pat19"
                                                    class="form-control form-control-sm" value="{{ $fin->pat19 }}"></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="number" name="cap_17" id="cap_17"
                                                    class="form-control form-control-sm" value="{{ $fin->cap_17 }}"></td>
                                            <td><input type="number" name="cap_18" id="cap_18"
                                                    class="form-control form-control-sm" value="{{ $fin->cap_18 }}"></td>
                                            <td><input type="number" name="cap_19" id="cap_19"
                                                    class="form-control form-control-sm" value="{{ $fin->cap_19 }}"></td>
                                        </tr>

                                        <tr>
                                            <td>(ii) Source of Funds</td>
                                            <td><input type="number" name="sof_17" id="sof_17"
                                                    class="form-control form-control-sm" value="{{ $fin->sof_17 }}" readonly></td>
                                            <td><input type="number" name="sof_18" id="sof_18"
                                                    class="form-control form-control-sm" value="{{ $fin->sof_18 }}" readonly></td>
                                            <td><input type="number" name="sof_19" id="sof_19"
                                                    class="form-control form-control-sm" value="{{ $fin->sof_19 }}" readonly></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="sh_cap_17" id="sh_cap_17"
                                                    class="form-control form-control-sm" value="{{ $fin->sh_cap_17 }}" readonly></td>
                                            <td><input type="number" name="sh_cap_18" id="sh_cap_18"
                                                    class="form-control form-control-sm" value="{{ $fin->sh_cap_18 }}" readonly></td>
                                            <td><input type="number" name="sh_cap_19" id="sh_cap_19"
                                                    class="form-control form-control-sm" value="{{ $fin->sh_cap_19 }}" readonly></td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;&nbsp;&nbsp;- Promoters</td>
                                            <td><input type="number" name="eq_prom_17" id="eq_prom_17"
                                                    class="form-control form-control-sm" value="{{ $fin->eq_prom_17 }}"></td>
                                            <td><input type="number" name="eq_prom_18" id="eq_prom_18"
                                                    class="form-control form-control-sm" value="{{ $fin->eq_prom_18 }}"></td>
                                            <td><input type="number" name="eq_prom_19" id="eq_prom_19"
                                                    class="form-control form-control-sm" value="{{ $fin->eq_prom_19 }}"></td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;&nbsp;&nbsp;- Indian Govt.</td>
                                            <td><input type="number" name="eq_ind_17" id="eq_ind_17"
                                                    class="form-control form-control-sm" value="{{ $fin->eq_ind_17 }}"></td>
                                            <td><input type="number" name="eq_ind_18" id="eq_ind_18"
                                                    class="form-control form-control-sm" value="{{ $fin->eq_ind_18 }}"></td>
                                            <td><input type="number" name="eq_ind_19" id="eq_ind_19"
                                                    class="form-control form-control-sm" value="{{ $fin->eq_ind_19 }}"></td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;&nbsp;&nbsp;- Foreign Govt.</td>
                                            <td><input type="number" name="eq_frn_17" id="eq_frn_17"
                                                    class="form-control form-control-sm" value="{{ $fin->eq_frn_17 }}"></td>
                                            <td><input type="number" name="eq_frn_18" id="eq_frn_18"
                                                    class="form-control form-control-sm" value="{{ $fin->eq_frn_18 }}"></td>
                                            <td><input type="number" name="eq_frn_19" id="eq_frn_19"
                                                    class="form-control form-control-sm" value="{{ $fin->eq_frn_19 }}"></td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;&nbsp;&nbsp;- Multilateral Agencies</td>
                                            <td><input type="number" name="eq_mult_17" id="eq_mult_17"
                                                    class="form-control form-control-sm" value="{{ $fin->eq_mult_17 }}"></td>
                                            <td><input type="number" name="eq_mult_18" id="eq_mult_18"
                                                    class="form-control form-control-sm" value="{{ $fin->eq_mult_18 }}"></td>
                                            <td><input type="number" name="eq_mult_19" id="eq_mult_19"
                                                    class="form-control form-control-sm" value="{{ $fin->eq_mult_19 }}"></td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;&nbsp;&nbsp;- Banks & Other institutions</td>
                                            <td><input type="number" name="eq_bank_17" id="eq_bank_17"
                                                    class="form-control form-control-sm" value="{{ $fin->eq_bank_17 }}"></td>
                                            <td><input type="number" name="eq_bank_18" id="eq_bank_18"
                                                    class="form-control form-control-sm" value="{{ $fin->eq_bank_18 }}"></td>
                                            <td><input type="number" name="eq_bank_19" id="eq_bank_19"
                                                    class="form-control form-control-sm" value="{{ $fin->eq_bank_19 }}"></td>
                                        </tr>
                                        <tr>
                                            <td>Internal Accruals</td>
                                            <td><input type="number" name="int_acc_17" id="int_acc_17"
                                                    class="form-control form-control-sm" value="{{ $fin->int_acc_17 }}"></td>
                                            <td><input type="number" name="int_acc_18" id="int_acc_18"
                                                    class="form-control form-control-sm" value="{{ $fin->int_acc_18 }}"></td>
                                            <td><input type="number" name="int_acc_19" id="int_acc_19"
                                                    class="form-control form-control-sm" value="{{ $fin->int_acc_19 }}"></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="ln_prom_17" id="ln_prom_17"
                                                    class="form-control form-control-sm" value="{{ $fin->ln_prom_17 }}"></td>
                                            <td><input type="number" name="ln_prom_18" id="ln_prom_18"
                                                    class="form-control form-control-sm" value="{{ $fin->ln_prom_18 }}"></td>
                                            <td><input type="number" name="ln_prom_19" id="ln_prom_19"
                                                    class="form-control form-control-sm" value="{{ $fin->ln_prom_19 }}"></td>
                                        </tr>
                                        <tr>
                                            <td>Indian Govt.</td>
                                            <td><input type="number" name="ln_ind_17" id="ln_ind_17"
                                                    class="form-control form-control-sm" value="{{ $fin->ln_ind_17 }}"></td>
                                            <td><input type="number" name="ln_ind_18" id="ln_ind_18"
                                                    class="form-control form-control-sm" value="{{ $fin->ln_ind_18 }}"></td>
                                            <td><input type="number" name="ln_ind_19" id="ln_ind_19"
                                                    class="form-control form-control-sm" value="{{ $fin->ln_ind_19 }}"></td>
                                        </tr>
                                        <tr>
                                            <td>Foreign Govt.</td>
                                            <td><input type="number" name="ln_frn_17" id="ln_frn_17"
                                                    class="form-control form-control-sm" value="{{ $fin->ln_frn_17 }}"></td>
                                            <td><input type="number" name="ln_frn_18" id="ln_frn_18"
                                                    class="form-control form-control-sm" value="{{ $fin->ln_frn_18 }}"></td>
                                            <td><input type="number" name="ln_frn_19" id="ln_frn_19"
                                                    class="form-control form-control-sm" value="{{ $fin->ln_frn_19 }}"></td>
                                        </tr>
                                        <tr>
                                            <td>Multilateral Agencies</td>
                                            <td><input type="number" name="ln_mult_17" id="ln_mult_17"
                                                    class="form-control form-control-sm" value="{{ $fin->ln_mult_17 }}"></td>
                                            <td><input type="number" name="ln_mult_18" id="ln_mult_18"
                                                    class="form-control form-control-sm" value="{{ $fin->ln_mult_18 }}"></td>
                                            <td><input type="number" name="ln_mult_19" id="ln_mult_19"
                                                    class="form-control form-control-sm" value="{{ $fin->ln_mult_19 }}"></td>
                                        </tr>
                                        <tr>
                                            <td>Banks & Other institutions</td>
                                            <td><input type="number" name="ln_bank_17" id="ln_bank_17"
                                                    class="form-control form-control-sm" value="{{ $fin->ln_bank_17 }}"></td>
                                            <td><input type="number" name="ln_bank_18" id="ln_bank_18"
                                                    class="form-control form-control-sm" value="{{ $fin->ln_bank_18 }}"></td>
                                            <td><input type="number" name="ln_bank_19" id="ln_bank_19"
                                                    class="form-control form-control-sm" value="{{ $fin->ln_bank_19 }}"></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="gr_ind_17" id="gr_ind_17"
                                                    class="form-control form-control-sm" value="{{ $fin->gr_ind_17 }}"></td>
                                            <td><input type="number" name="gr_ind_18" id="gr_ind_18"
                                                    class="form-control form-control-sm" value="{{ $fin->gr_ind_18 }}"></td>
                                            <td><input type="number" name="gr_ind_19" id="gr_ind_19"
                                                    class="form-control form-control-sm" value="{{ $fin->gr_ind_19 }}"></td>
                                        </tr>
                                        <tr>
                                            <td>Foreign Govt.</td>
                                            <td><input type="number" name="gr_frn_17" id="gr_frn_17"
                                                    class="form-control form-control-sm" value="{{ $fin->gr_frn_17 }}"></td>
                                            <td><input type="number" name="gr_frn_18" id="gr_frn_18"
                                                    class="form-control form-control-sm" value="{{ $fin->gr_frn_18 }}"></td>
                                            <td><input type="number" name="gr_frn_19" id="gr_frn_19"
                                                    class="form-control form-control-sm" value="{{ $fin->gr_frn_19 }}"></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="w-20" colspan="2">
                                                <select id="rnd_unit" name="rnd_unit"
                                                    ...
                                                    <option value="Y" @if($fin->rnd_unit == 'Y') selected @endif>Yes</option>
                                                    <option value="N" @if($fin->rnd_unit == 'N') selected @endif>No</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="w-20" colspan="2">
                                                <select id="rnd_rcnz" name="rnd_rcnz"
                                                    class="form-control form-control-sm">
                                                    <option value="" selected="selected">Please choose..</option>
                                                    <option value="Y" @if($fin->rnd_rcnz == 'Y') selected @endif>Yes</option>
                                                    <option value="N" @if($fin->rnd_rcnz == 'N') selected @endif>No</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr class="table-primary">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="rnd_inv_17" id="rnd_inv_17"
                                                    class="form-control form-control-sm" value="{{ $fin->rnd_inv_17 }}"></td>
                                            <td><input type="number" name="rnd_inv_18" id="rnd_inv_18"
                                                    class="form-control form-control-sm" value="{{ $fin->rnd_inv_18 }}"></td>
                                            <td><input type="number" name="rnd_inv_19" id="rnd_inv_19"
                                                    class="form-control form-control-sm" value="{{ $fin->rnd_inv_19 }}"></td>
                                        </tr>
                                        <tr>
                                            <th class="w-40 p-1" colspan="2">
                                            ...
                                            <td class="w-20" colspan="2">
                                                <select id="rnd_achv" name="rnd_achv"
                                                    class="form-control form-control-sm">
                                                    <option value="" selected="selected">Please choose..</option>
                                                    <option value="Y" @if($fin->rnd_achv == 'Y') selected @endif>Yes</option>
                                                    <option value="N" @if($fin->rnd_achv == 'N') selected @endif>No</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
