                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover table-sm">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <th class="p-0" rowspan="2">Details of Authorised Signatory <br>
                                                            @if(!empty($old_signatory)>0)  <a class="mt-2 btn-sm btn-success sign_view" style="padding: 5px;">View</a> @endif
                                                            </th>
                                                        ...
                                                        @if(!empty($old_signatory)>0)
                                                        <tr class="old_sign">
                                                            <th>Old Details of Authorised Signatory</th>
                                                            <td class="text-center">
                                                                {{$old_signatory->old_contact_person }}
                                                            </td>
                                                            <td class="text-center">
                                                                {{ $old_signatory->old_designation }}
                                                            </td>
                                                            <td class="text-center">
                                                                {{ $old_signatory->old_email }}
                                                            </td>
                                                            <td class="text-center">
                                                                {{ $old_signatory->old_mobile }}
                                                            </td>
                                                        </tr>
                                                        @endif
                                                        <tr>
                                                ...
                                                <table class="table table-bordered table-hover table-sm">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="text-center">{{ Auth::user()->type }}</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <th rowspan="{{ Count($others) + 1}}">Other than Promoter &
                                                                Promoter Group</th>
                                                        </tr>
                                                        @endforeach
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover table-sm">
                                                    <tbody>
                                                        ...
                                                        @if(!empty($old_corporate) || !empty($old_reg_data))
                                                        <tr class="old_address">
                                                            <td colspan="2" style="padding: 0;">
                                                                <table style="margin: 0; width: 100%;">
                                                                    <tbody><tr>
                                                                        @if(!empty($old_reg_data))
                                                                        <th>Old Registered Office Address</th>
                                                                        <td>
                                                                            {{ $old_reg_data->corp_add }},{{ $old_reg_data->corp_state }},{{ $old_reg_data->corp_city}},{{ $old_reg_data->corp_pin}}
                                                                        </td>
                                                                        @endif
                                                                        @if(!empty($old_corporate))
                                                                            <th>Old Corporate Office Address</th>
                                                                            <td>  {{ $old_corporate->off_add }},{{ $old_corporate->off_state }},{{ $old_corporate->off_city}},{{ $old_corporate->off_pin}} </td>
                                                                        @endif
                                                                    </tr>
                                                                    </tbody>
                                                                </table>
...
@include('user.partials.js.submit')
@endpush
