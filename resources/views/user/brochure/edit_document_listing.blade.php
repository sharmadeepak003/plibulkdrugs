...
<form action="{{ route('app_brochure.update',$brochure_doc->id) }}" id="brochure-create" role="form" method="post"
                        ...
                        <table class="table table-sm table-bordered table-hover uploadTable">
                            ...
                            <tr>
                                ...
                                <td><input type="file" id="broch_other_doc" name="broch_other_doc"  class="form-control form-control-sm valid">
                                    {{-- @if(isset($brochure_doc->other_uploaded_file))
                                        <a href="{{ route('app_brochure.other_broch_down', encrypt($brochure_doc->id)) }}" 
                                            class="btn btn-success btn-sm float-centre">
                                            Download</a>
                                    @endif     --}}
                                </td>
...
{!! JsValidator::formRequest('App\Http\Requests\User\EditBrochureDocUploads','#brochure-create') !!}
@endpush