<style>
    ...
    <div class="modal fade" id="editModal{{ $qrr->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-body">
                    <div class="flex-parent">
                        <div class="input-flex-container">                            
                            @foreach ($qrrMaster[$qrr->id] as $value) 
                            <a class="input" href="{{ route('qpr.edit',$qrr->id) }}">
                            ...
                            <a class="input" href="{{ route('revenue.edit',$qrr->id) }}">
                            ...
                            <a class="input" href="{{ route('projectprogress.edit',$qrr->id) }}">
                            ...
                            <a class="input" href="{{ route('uploads.edit',$qrr->id) }}">
                            ...
                            <a class="input" href="{{ route('qrradditionalinfo.edit',$qrr->id) }}">
                                @if(in_array(5,$value->qrrstages->where('qrr_id',$value->id)->pluck('stage')->toArray()))
                                <span data-year="Edit" data-info="Approvals Required"></span>
                                @else
                                <span data-info="Approvals Required"></span>
                                @endif
                            </a>
